...
for i in range(begin,end):
    if(i%10==0):
        ...
        image.resize((256,256)).save('/dev/shm/isc_100k_256_big/isc_100k_256_big/'+name, quality=100)
        for j in range(1,20):
            image_q = transform_q(image)
            name = str(i//10)+'_'+ str(j) +'.jpg'
            image_q.save('/dev/shm/isc_100k_256_big/isc_100k_256_big/'+name, quality=100)
