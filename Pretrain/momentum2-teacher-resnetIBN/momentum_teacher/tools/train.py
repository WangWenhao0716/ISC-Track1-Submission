...
def main_worker(gpu, nr_gpu, args):
    ...
    name = "/gs/home/wangwh/momentum2-teacher-resnet50-ibn/outputs/imagenet_baseline_resnet50ibn/last_epoch_ckpt.pth.tar"
    if(os.path.exists(name)):
        resume = torch.load(name, map_location=torch.device('cpu'))
